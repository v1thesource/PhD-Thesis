...
\ch{Te^{132}} & 1.5042 & 3.180 d \cite{Te132} \\
\ch{I^{132}} & 0.028399  & 2.295 h \cite{Te132} \\
\ch{Te^{133}} & 3.9386 & 12.5 m \cite{khazov2011nuclear} \\
\ch{I^{133}} & 0.198194  & 20.87 h \cite{I133} \\
\ch{Te^{134}} & 6.3001 & 41.8 m \cite{Sonzogni2004} \\
\ch{I^{134}} & 0.7673 & 52.5 m \cite{Sonzogni2004} \\
\ch{Te^{135}} & 3.4777 & 19.0 s \cite{tellurium135halflife} \\
\ch{I^{135}} & 2.4635 & 6.58 h \cite{tellurium135halflife} \\ 
\ch{Te^{136}} & 1.6652 & 17.63  s \cite{Mccutchan2018} \\
\ch{I^{136}} & 3.03823 & 83.4 s \cite{Mccutchan2018} \\
\ch{Te^{137}} & 0.48440 & 2.49 s \cite{browne2007nuclear} \\
\ch{I^{137}} & 2.7026 & 24.5 s \cite{browne2007nuclear} \\ 
\ch{Te^{138}} & 0.11280 & 1.4 s \cite{chen2017nuclear} \\ 
\ch{I^{138}} & 1.2419 & 6.26 s \cite{chen2017nuclear} \\ 
\hline
\end{tabular}
\end{center}
\end{table}
...
\end{gather}
UO$_{2}$ fuel pellets do not contain any plutonium before irradiation, however, production of \ch{Pu^{239}} during reactor operation is so significant that over 40\% of the energy produced (in a LWR) is from the fission of \ch{Pu^{239}}. A fraction of the \ch{Pu^{239}} nuclei will capture additional neutrons, producing heavier isotopes of plutonium which may be fissile (e.g. \ch{Pu^{241}}). The production of fissile nuclei from fertile nuclei is known as \emph{breeding}.
