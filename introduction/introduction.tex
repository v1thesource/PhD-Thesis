...
\caption{Energy from thermal fission of U-235 as a function of mass ratios of child nuclei. Total energy release includes contributions from prompt neutrons and gamma rays. Taken from \cite{aras1965ranges}.}
...
\begin{equation}
\label{fission}
    U^{235}_{92} + n^{1}_{0} -> I^{131}_{53} + Y^{101}_{39} + 3n^{1}_{0} 
\end{equation}
...
\caption{Plot binding energy per nucleon against mass number. Arrows indicate the reaction shown in equation \ref{fission}. Taken from }
