...
When the fuel pellet makes contact with the cladding, there is also a chemical interaction between the UO$_{2}$ (and fission products) and the internal surface oxide of the cladding. UO$_{2}$ is soluble in ZrO$_{2}$ up to x\% molar mass and we therefore see a bonded reaction layer which is of the form (U, Zr)O$_{2}$. This layer adopts the crystal structure of cubic fluorite, the high temperature phase of ZrO$_{2}$.
...
\caption[Reactor startup procedure for a typical US PWR.]{Reactor startup procedure for a typical US PWR. Adapted from \cite{ramping}.}
% M. F. James, R. W. Mills and D. R. Weaver (1991) UKAEA Reports, AEA-TRS-1015, AEA-TRS-1018 
         %  and AEA-TRS-1019.
