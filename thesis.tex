...
\input{literature/literature} % Good
\input{crystallography/crystallography} % Complete 
\input{compmethodology/compmethodology} % Good
%\input{defects/defects.tex} % Good
...
\end{itemize}
The rate of change of tellurium and iodine populations (\ch{N_{Te}} and \ch{N_{I}}) can be expressed by:
\begin{gather}
